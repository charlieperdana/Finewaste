//
//  MyContributeProjectGridView.swift
//  Finewaste
//
...
struct MyContributeProjectGridView: View {
    @ObservedObject var model: MyContributeProjectViewModel
...
struct MyContributeProjectGridView_Previews: PreviewProvider {
    @State static var searchText = ""
    
    static var previews: some View {
        MyContributeProjectGridView(model: MyContributeProjectViewModel(user: "---"), searchText: $searchText)
    }
}
